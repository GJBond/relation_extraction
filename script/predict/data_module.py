...
def filed_based_convert_examples_to_features(examples, label_list, triargus,max_seq_length, tokenizer, output_file, mode=None):
    ...
    for ( example,triargu) in zip(examples,triargus):
        ...
        feature, ntokens, label_ids,subj_token = convert_single_example(ex_index, example, triargu,label_list, max_seq_length, tokenizer,
                                                             mode)
        ...
        features["subj_token"] = create_int_feature(subj_token)
...
def file_based_input_fn_builder(input_file, seq_length, is_training, drop_remainder):
    name_to_features = {
        ...
        "subj_token": tf.io.FixedLenFeature([50],tf.int64),
    }
